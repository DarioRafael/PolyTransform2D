...
public class DrawingFrameDiagonal extends JFrame {
    ...
    public DrawingFrameDiagonal() {
        ...
        SwingUtilities.invokeLater(() -> {
            figurasComboBox.setSelectedItem("Diagonal");
        });
    ...
    private void configureLayout() {
        ...
        JLabel circleLabel = new JLabel("Linea diagonal");
        ...
        valoresIniciales.put("Diagonal", new int[]{1, 1, 7, 7});   // x1,y1,x2,y2
